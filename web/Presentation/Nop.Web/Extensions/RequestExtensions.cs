...
namespace Nop.Web.Extensions
{
    public static class RequestExtensions
    {
        ...
        public static string GetRawBody(this HttpRequest request, Encoding encoding = null)
        {
            if (encoding == null)
        ...
        public static T GetBody<T>(this HttpRequest request, Encoding encoding = null)
        {
            if (encoding == null)
                encoding = Encoding.UTF8;
