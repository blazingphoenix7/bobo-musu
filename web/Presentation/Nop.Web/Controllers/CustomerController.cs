...
namespace Nop.Web.Controllers
{
  public partial class CustomerController : BasePublicController
  {
    ...
    public CustomerController(AddressSettings addressSettings,
        ...
        TaxSettings taxSettings, IPrintService printService)
    {
    ...
    public virtual IActionResult Login(bool? checkoutAsGuest)
    {
      ...
      ViewData[ViewDataKey.SHOW_GO_TO_TOP] = false;
      ViewData[ViewDataKey.APPLY_BACK] = true;
      ViewData[ViewDataKey.BACK_ICON_CLASS] = "home-icon";
      ViewData[ViewDataKey.BACK_ACTION] = Url.Action("Index", "Home", new { allowHome = true });
      ViewData[ViewDataKey.SHOW_FINGER_BACKGROUND] = true;
      return View(model);
    }
    ...
    public virtual IActionResult PasswordRecovery()
    {
      ...
      ViewData[ViewDataKey.SHOW_GO_TO_TOP] = false;
      ViewData[ViewDataKey.APPLY_BACK] = true;
      ViewData[ViewDataKey.BACK_ACTION] = Url.Action("Login", "Customer");
      ViewData[ViewDataKey.SHOW_FINGER_BACKGROUND] = false;
      return View(model);
    }
    ...
    public virtual IActionResult PasswordRecoveryConfirm(string token, string email)
    {
      ...
      ViewData[ViewDataKey.SHOW_GO_TO_TOP] = false;
      ViewData[ViewDataKey.APPLY_BACK] = false;
      ViewData[ViewDataKey.SHOW_FINGER_BACKGROUND] = false;
      return View(model);
    }
    ...
    public virtual IActionResult Register(RegisterModel model, string returnUrl, bool captchaValid)
    {
      ...
      if (ModelState.IsValid)
      {
        ...
        if (registrationResult.Success)
        {
          ...
          // Match Customer In External Requests
          _printService.MatchCustomerInExternalRequests(customer);
