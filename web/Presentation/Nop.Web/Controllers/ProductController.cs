...
namespace Nop.Web.Controllers
{
  public partial class ProductController : BasePublicController
  {
    ...
    public virtual IActionResult ProductDetails(int productId, int updatecartitemid = 0)
    {
      ...
      //template
      var productTemplateViewPath = Request.Query["AddPrints"] == "1" ? "BMProductTemplate.AddPrints" : _productModelFactory.PrepareProductTemplateViewPath(product);

      ViewData[ViewDataKey.IS_PRODUCT_DETAIL_PAGE] = true;
