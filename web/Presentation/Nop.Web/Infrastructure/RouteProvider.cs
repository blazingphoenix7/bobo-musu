...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            #region Bobo Musu Mobile
          
            //BMMCatalog-ListCategories
            routeBuilder.MapLocalizedRoute("BMMCatalog-ListCategories",
                "mobile/catalog/listcategories",
                new { controller = "BMMCatalog", action = "ListCategories" });

            //BMMCatalog-ListProductsByCategory
            routeBuilder.MapLocalizedRoute("BMMCatalog-ListProductsByCategory",
                "mobile/catalog/listproductsbycategory/{categoryId}",
                new { controller = "BMMCatalog", action = "ListProductsByCategory"});

            #endregion

            #region Bobo Musu Web

            routeBuilder.MapLocalizedRoute("BMHomeWelcome",
                "welcome",
                new { controller = "BMHome", action = "welcome" });
            
            routeBuilder.MapLocalizedRoute("BMPendingRequests_Accept",
                "print/pendinglist/accept/{requestId}/{toCustomerId}",
                new { controller = "BMPrint", action = "PendingRequestAccept" });

            routeBuilder.MapLocalizedRoute("BMPendingRequests_Delete",
                "print/pendinglist/delete",
                new { controller = "BMPrint", action = "DeletePendingRequest" });

            routeBuilder.MapLocalizedRoute("BMMessages",
                "print/messagelist",
                new { controller = "BMPrint", action = "Messages" });

            routeBuilder.MapLocalizedRoute("BMMessage_Delete",
                "print/messagelist/delete",
                new { controller = "BMPrint", action = "DeleteMessage" }); 

            routeBuilder.MapLocalizedRoute("BMAskForPrint",
                "print/askforprint",
                new { controller = "BMPrint", action = "AskForPrint" });

            routeBuilder.MapLocalizedRoute("AskForPrintList",
                "print/askforprintlist",
                new { controller = "BMPrint", action = "AskForPrintList" }); 

            routeBuilder.MapLocalizedRoute("BMAskForPrint_Save",
                "print/askforprint/save",
                new { controller = "BMPrint", action = "AskForPrintSave" });
           
            routeBuilder.MapLocalizedRoute("BMMyPrints",
                "print/myprints",
                new { controller = "BMPrint", action = "MyPrints" });

            routeBuilder.MapLocalizedRoute("BMSharedPrints",
                "print/sharedprints",
                new { controller = "BMPrint", action = "SharedPrints" });

            routeBuilder.MapLocalizedRoute("BMDirectLogin", "directlogin",
                new { controller = "BMDirectLogin", action = "Index" });


            routeBuilder.MapLocalizedRoute("BMApiAddToCart", "api/addtocart",
                new { controller = "ShoppingCart", action = "AddToCart" });

            routeBuilder.MapLocalizedRoute("BMPrint_Delete",
                "print/myprints/delete",
                new { controller = "BMPrint", action = "DeletePrint" });
