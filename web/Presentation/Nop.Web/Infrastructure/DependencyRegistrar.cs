...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<DownloadModelFactory>().As<IDownloadModelFactory>().InstancePerLifetimeScope();
            ...
            // Bobo Musu factories
            builder.RegisterType<Factories.BM.PrintModelFactory>().As<Factories.BM.IPrintModelFactory>().InstancePerLifetimeScope();
        }
