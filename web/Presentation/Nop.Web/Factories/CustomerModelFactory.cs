...
namespace Nop.Web.Factories
{
    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
        ...
        public virtual CustomerNavigationModel PrepareCustomerNavigationModel(int selectedTabId = 0)
        {
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                RouteName = "BMPendingRequests",
                Title = "Pending Requests",
                Tab = CustomerNavigationEnum.PendingRequests,
                ItemClass = "rending-requests"
            });
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                ...
                Title = "Messages",
                Tab = CustomerNavigationEnum.Messages,
                ItemClass = "messages"
            });
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                ...
                Title = "Ask for Print",
                Tab = CustomerNavigationEnum.AskForPrint,
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                ...
                Title = "My Prints",
                Tab = CustomerNavigationEnum.MyPrints,
                ItemClass = "my-prints"
            });
            ...
            */
            /*model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                RouteName = "Wishlist",
                Title = "Saved Items",
                Tab = CustomerNavigationEnum.Wishlist,
                ItemClass = "wishlist"
            });
            */
