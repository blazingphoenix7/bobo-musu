...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
        ...
        IAclSupportedModel, IDiscountSupportedModel, ILocalizedModel<ProductLocalizedModel>, IStoreMappingSupportedModel
    {
        ...
        public ProductModel()
        {
            ...
            ProductModelTemplateSearchModel = new ProductModelTemplateSearchModel();
            AddModelTemplateModel = new ProductModelTemplateModel();
        }
        ...
        public ProductModelTemplateSearchModel ProductModelTemplateSearchModel { get; set; }

        public ProductModelTemplateModel AddModelTemplateModel { get; set; }

        [DisplayName("Number Of Prints")]
