...
namespace Nop.Web.Models.Catalog
{
    public partial class ProductDetailsModel : BaseNopEntityModel
    {
        ...
        {
            DefaultPictureModel = new ProductPictureModel();
            PictureModels = new List<ProductPictureModel>();
            GiftCard = new GiftCardModel();
            ProductPrice = new ProductPriceModel();
            AddToCart = new AddToCartModel();
            AddPrintToCart = new AddPrintToCartModel();
        ...
        public ProductPictureModel DefaultPictureModel { get; set; }
        ...
        public AddPrintToCartModel AddPrintToCart { get; set; }
        ...
        public partial class AddToCartModel : BaseNopModel
        {
            public AddToCartModel()
            {
                ...
                this.Prints = new List<PrintModel>();
            }
            public int ProductId { get; set; }
        ...
        public partial class AddPrintToCartModel : BaseNopModel
        {
            public AddPrintToCartModel()
            {
            }
            public int ProductId { get; set; }

            public int SelectedPrintId { get; set; }
