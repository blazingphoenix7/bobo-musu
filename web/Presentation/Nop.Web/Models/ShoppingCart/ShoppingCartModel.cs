    ...
    public partial class ShoppingCartModel : BaseNopModel
    {
        ...
        public partial class ShoppingCartItemModel : BaseNopEntityModel
        {
            public ShoppingCartItemModel()
            {
                ...
                PrintShoppingCartItems = new List<PrintShoppingCartItemModel>();
                Warnings = new List<string>();
            }
            ...
            public List<PrintShoppingCartItemModel> PrintShoppingCartItems { get; set; }
        }

        public partial class PrintShoppingCartItemModel : BaseNopEntityModel
        {
