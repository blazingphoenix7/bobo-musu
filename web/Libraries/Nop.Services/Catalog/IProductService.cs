...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IList<ProductModelTemplate> GetProductModelTemplatesByProductId(int productId);

        ProductModelTemplate GetProductModelTemplateById(int productModelTemplateId);

        void InsertProductModelTemplate(ProductModelTemplate productModelTemplate);

        void UpdateProductModelTemplate(ProductModelTemplate productModelTemplate);

        void DeleteProductModelTemplate(ProductModelTemplate productModelTemplate);
