...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class OrderItem : BaseEntity
    {
        ...
        private ICollection<PrintOrderItem> _printOrderItems;
        ...
        public virtual ICollection<PrintOrderItem> PrintOrderItems
        {
            get => _printOrderItems ?? (_printOrderItems = new List<PrintOrderItem>());
            protected set => _printOrderItems = value;
        }
    }
}
