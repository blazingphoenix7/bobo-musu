...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported
    {
        ...
        private ICollection<ProductModelTemplate> _productModelTemplates;
        ...
        public virtual ICollection<ProductModelTemplate> ProductModelTemplates
        {
            get => _productModelTemplates ?? (_productModelTemplates = new List<ProductModelTemplate>());
            protected set => _productModelTemplates = value;
        }
    }
}